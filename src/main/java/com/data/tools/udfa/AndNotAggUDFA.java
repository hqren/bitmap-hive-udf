 ...
 * create temporary function rb_andnot_agg as 'com.data.tools.udfa.AndNotAggUDFA';
 */
public class AndNotAggUDFA extends AbstractGenericUDAFResolver {
    @Override
...
//            return PrimitiveObjectInspectorFactory.writableLongObjectInspector;
        ...
        public void merge(AggregationBuffer agg, Object partial) throws HiveException {
            if (partial != null) {
                ...
                myagg.sum = RoaringBitmapUtils.andNot(oldValue, newValue);
                myagg.empty = false;
            }
        }
